...
public class VentanaEntrada extends javax.swing.JFrame {
    ...
    private void accederJBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_accederJBActionPerformed
        ...
        VentanaFormulario ven = new VentanaFormulario(pacientes);
    ...
    public void llenarArrayList() throws UnsupportedEncodingException{
        ...
        try {
            while(resultSet.next()){
                ...
                telf = resultSet.getInt(7);
                fechaNacimiento = resultSet.getDate(8);
                fechaAlta = resultSet.getDate(9);
                
                Pacientes paciente = new Pacientes(nuss, dni, nombre, primerApellido, segundoApellido, direccion, telf, fechaNacimiento, fechaAlta);
